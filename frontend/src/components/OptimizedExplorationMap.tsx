                ...
                <div className="flex-shrink-0 p-4 border-t border-gray-600/30 border border-gray-600/30 bg-transparent rounded-lg">
                  <div className="space-y-2">
                    ...
                    <button
                      ...
                      title="Go to Home"
                    >
                      <Home className="w-5 h-5 text-gray-400 group-hover:text-[#8B8B4A] transition-colors" />
                      <span className="text-sm font-medium text-gray-300 group-hover:text-[#6B6B3A] transition-colors">Home</span>
                    </button>
                  </div>
                </div>
              </>
          ...
          <div className="flex-1 relative overflow-hidden">
            ...
            <div className="absolute top-4 left-4 z-40 flex gap-2">
              ...
              <button
                ...
                className={`p-2 glass-pane-no-glow hover:bg-red-500/20 transition-colors rounded ${
            ...
            {canvasState.isConnecting && (
              <div className="absolute top-20 left-1/2 transform -translate-x-1/2 glass-pane-no-glow px-4 py-2 text-sm text-[#6B6B3A] z-40 border border-[#6B6B3A]/30">
